...
perl targets/x86_64-pc-windows-msvcrt/pdb-patch.pl %WORKING_DIR%\llvm\cmake\modules\AddLLVM.cmake
...
perl targets/x86_64-pc-windows-msvcrt/compare-versions.pl %LLVM_VERSION% 11
if %errorlevel% == -1 goto nobigobj

perl targets/x86_64-pc-windows-msvcrt/compare-versions.pl %LLVM_VERSION% 12
